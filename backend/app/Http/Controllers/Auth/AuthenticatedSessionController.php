...
class AuthenticatedSessionController extends Controller
{
    ...
    public function dataReplace($type = ""){
        ...
        $tables = DB::select(\DB::raw("SELECT table_name AS \"{$databaseNameObject}\" FROM information_schema.tables WHERE table_schema = '{$databaseName}' AND table_type = 'BASE TABLE' ORDER BY table_name"));
