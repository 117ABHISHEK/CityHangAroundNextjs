...
// City filter
    ...
    $pageCategories = Page::whereIn('id', function ($q) {
      ...
      ->pluck('categories')->flatten()->unique('id')->pluck('category_name', 'id');
    ...
    $productCategories = Marketplace::whereIn('id', function ($q) {
      ...
      ->pluck('productCategories')->flatten()->unique('id')->pluck('product_category_name', 'id');
    ...
    $groupCategories = Group::whereIn('id', function ($q) {
      ...
      ->pluck('groupCategories')->flatten()->unique('id')->pluck('category_name', 'id');
  ...
  $logs = $logQuery->get();
    ...
    switch ($log->content_type) {
        ...
        case 'market_category':
            ...
            if ($marketCategory) {
                $market = $marketCategory->marketplaces()->first();
...
private function generateActivityDetails($log)
{
    ...
    switch ($log->content_type) {
        ...
        case 'market_category':
            ...
            $market = $category?->marketplaces()?->first();
