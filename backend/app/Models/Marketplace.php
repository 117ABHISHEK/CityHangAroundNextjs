...
// ❌ BROKEN: marketplaces.category is CSV text, not a proper FK — cannot use in belongsTo
// Use getCategoryObjectsAttribute() or getMasterCategoryLeadPriceAttribute() instead.
