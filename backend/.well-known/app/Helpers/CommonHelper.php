...
if (! function_exists('get_product_image')) {
    function get_product_image($file_name = "", $foldername = "") {
        ...
        $defaultPath = public_path("storage/marketplace/$foldername/default/default.jpg");
...
if (! function_exists('get_page_logo')) {
    function get_page_logo($file_name = "", $foldername = "") {
        ...
        if(!empty($file_name)){
           // Return root-relative absolute URL
            return '/storage/pages/'.$foldername.$file_name;
        }else{
...
if (! function_exists('get_page_cover_photo')) {
    function get_page_cover_photo($file_name = "", $foldername = "coverphoto") {
        ...
        // 4. Fallback
        return asset('storage/pages/default/default.jpg');
    }
