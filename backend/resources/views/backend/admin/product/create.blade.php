        ...
        <div class="eSection-wrap-2">
            <div class="eForm-layouts">
              @if ($errors->any())
                ...
                @endif
<form  action="{{ route('admin.product.created') }}" method="POST" enctype="multipart/form-data">
    @csrf
   ...
   <div class="form-group">
    ...
    <div class="form-group">
        <label for="#" class="form-label eForm-label">{{ get_phrase('Product Name') }}</label>
        <input type="text" name="title" class="form-control eForm-control" placeholder="Your Product Title">
    </div>

    <div class="form-group row">
        <div class="col-md-12">
            <label for="brand">{{get_phrase('Brand')}}</label>
            <select name="brand" id="brand" required class="form-select eForm-control select2 @error('category') is-invalid @enderror" >
                <option value="" disabled selected>{{ get_phrase('Select Brand') }}</option>
                @foreach ($brands as $brand )
                    <option value="{{ $brand->id }}" >{{ ucfirst($brand->name) }}</option>
                @endforeach
            </select>
            <a  class="text-logo pl-2 float-left" onclick="showbrandmodel();" >
         <i class="far fa-add"></i>
    ...
    <div class="form-group">
        ...
        <select name="currency" id="currency" required class="form-select eForm-control select2 @error('currency') is-invalid @enderror">
    ...
    <div class="form-group">
        ...
        <select name="List" id="List" required class="form-select eForm-control select2 @error('List') is-invalid @enderror">
    ...
    <div class="row">
        <div class="col-lg-6">
        <div class="form-group">
        <label for="#" class="form-label eForm-label">{{ get_phrase('Original Price') }}</label>
        <input type="number" name="price" class="form-control eForm-control" placeholder="Your Price">
    </div>
        </div>

        <div class="col-lg-6">
        <div class="form-group">
        <label for="#" class="form-label eForm-label">{{ get_phrase('Selling Price') }}</label>
        <input type="number" name="selling_price" class="form-control eForm-control" placeholder="Your Selling Price">
    </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-6">
        <div class="form-group">
        <label for="#" class="form-label eForm-label">{{ get_phrase('Video Url') }}</label>
        <input type="text" name="video_url" class="form-control eForm-control" placeholder="Video URL">
    </div>
        </div>

        <div class="col-lg-6">
        <div class="form-group">
        <label for="#" class="form-label eForm-label">{{ get_phrase('Featured Product-Service') }}</label>
        <select name="featured" required class="form-select eForm-control select2 @error('featured') is-invalid @enderror" >
                                <option value="0"  >{{ get_phrase('select') }}</option>
    ...
    <div class="row">
        <div class="col-lg-6">
        <div class="form-group">
        <label for="#" class="form-label eForm-label">{{ get_phrase('Start Date') }}</label>
        <input type="date" name="start_date" class="form-control eForm-control" placeholder="Start Date">
    </div>
        </div>
        ...
        <input type="date" name="end_date" class="form-control eForm-control" placeholder="End Date">
    </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" name="location" class="form-control eForm-control" placeholder="Your Location">
    </div>
     <div class="form-group row">
        <div class="col-md-12">
            <label for="condition">{{ get_phrase('Condition') }}</label>
            <select name="condition" required class="form-select eForm-control select2 @error('condition') is-invalid @enderror">
     ...
     <div class="form-group row">
        <div class="col-md-12">
            ...
            <select name="status" required class="form-select eForm-control select2 @error('condition') is-invalid @enderror">
     ...
     <div class="form-group">
        ...
        <input type="url" name="buy_link" id="buy_link" class="form-control eForm-control" placeholder="{{get_phrase('Enter the buy link')}}">
    </div>

    <div class="form-group">
        <label for="#">{{ get_phrase('Description') }}</label>
        <textarea type="text" name="description" class="content" id="description" rows="10" placeholder="Your Description"></textarea>
    </div>
    <div id="frames"></div>
    <div class="form-group">
