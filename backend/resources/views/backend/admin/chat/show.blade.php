...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <span class="text-muted">Page: {{ $conversation->page->title ?? 'N/A' }}</span>
    </div>
    ...
    <form id="chat-form" enctype="multipart/form-data" class="chat-footer">
        ...
        <div class="input-group">
            ...
            <button class="btn" type="submit" style="background-color:#ff4b4b; color:white">
...
<script>
    let lastMessageId = {{ optional($messages->last())->id ?? 0 }}; // GLOBAL
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        chatForm.addEventListener('submit', function (e) {
            ...
            fetch("{{ route('admin.all.conversations.message', $conversation->id) }}", {
                method: "POST",
                body: formData
            })
            .then(res => res.json())
            .then(data => {
                    ...
                    <div class="chat-message user">
                        ...
                        <div class="chat-bubble">
                            ...
                            ${data.image_url ? `<div class="mt-2">
                                <img src="${data.image_url.startsWith('http') ? data.image_url : '/pages/chat_images/' + data.image_url}" class="chat-image" />
                            </div>` : ''}
                ...
                messageInput.value = '';
                imageInput.value = '';
                lastMessageId = data.id; // this updates global variable
            })
            .catch(err => {
        ...
        function fetchNewMessages() {
            fetch("{{ route('admin.page.chat.fetch', ['id' => $conversation->id]) }}?last_id=" + lastMessageId)
                .then(res => res.json())
                .then(data => {
                    ...
                    newMessages.forEach(msg => {
                        ...
                        chatBox.insertAdjacentHTML('beforeend', html);
                        chatBox.scrollTop = chatBox.scrollHeight;
                        lastMessageId = msg.id; // global update
                    });
                })
