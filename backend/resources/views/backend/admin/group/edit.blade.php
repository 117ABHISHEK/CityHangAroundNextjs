...
<div class="main_content">
        ...
        <div class="eSection-wrap-2">
            <div class="eForm-layouts">
              @if ($errors->any())
                ...
                @endif
                <form action="{{ route('admin.group.updated',['id'=>$group->id]) }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
                                ...
                                <select class="form-select eForm-control select2 @error('item_status') is-invalid @enderror" name="item_status">
                                    ...
                                    <option value="1"  {{ $group->group_status=="1" ? "selected":"" }}>Submitted</option>
                                    <option value="2" {{ $group->group_status=="2" ? "selected":"" }}>Published</option>
                                    <option value="3" {{ $group->group_status=="3" ? "selected":"" }}>Suspended</option>
    ...
    <div class="form-group">
        <label for="form-label eForm-label">{{ get_phrase('Group Title') }}</label>
        <input type="text" class="form-control eForm-control"  name="name" value="{{ $group->title }}"  placeholder="Enter your page Name">
    </div>
    <div class="form-group">
        <label for="form-label eForm-label">{{ get_phrase('Group Sub Title') }}</label>
        <input type="text" class="form-control eForm-control" name="subtitle" value="{{ $group->subtitle }}" placeholder="Enter your page Name">
    </div>
    <?php $category_array=explode(',', $group->category_id);?>
    <div class="form-group">
        <label for="form-label eForm-label">{{ get_phrase('Category') }}</label>
    ...
    <div class="form-group">
        <label for="form-label eForm-label">{{ get_phrase('Keyword tag(Hashtag)') }}</label>
    ...
    <div class="form-group">
        <label for="form-label eForm-label">{{ get_phrase('About') }}</label>
        <textarea name="about" class="border-0 bg-secondary content" id="about" cols="30" rows="10" placeholder="About Group">{{ $group->about }}</textarea>
    </div>
    <div class="row">
    <div class="col-lg-6">
    <div class="form-group">
        <label for="form-label eForm-label">{{ get_phrase('State') }}</label>
...
<div class="col-lg-6">
    <div class="form-group">
        <label for="form-label eForm-label">{{ get_phrase('City') }}</label>
   ...
   <div class="col-lg-6">
    <div class="form-group">
        <label for="form-label eForm-label">{{ get_phrase('Area') }}</label>
...
<div class="mb-3">
        <label for="form-label eForm-label">{{ get_phrase('Status') }}</label>
        <select name="status" id="status" class="form-select eForm-control select2 @error('item_status') is-invalid @enderror">
    ...
    <div class="mb-3">
        <label for="form-label eForm-label">{{ get_phrase('Update Profile Photo') }}</label>
        <input type="file" name="image" id="image" class="form-control eForm-control-file">
    </div>
