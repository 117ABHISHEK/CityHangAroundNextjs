...
<form class="event-form" action="{{ route('admin.update.event',$event->id) }}" method="POST" enctype="multipart/form-data" >
    @csrf
    ...
    @if ($errors->any())
     ...
     <div class="form-group mt-3">
        ...
        <select class="selectpicker eForm-control select2 @error('event_status') is-invalid @enderror" name="event_status">
    ...
    <div class="form-group mt-3">
        ...
        <input type="text" name="eventname" class="form-control eForm-control" value="{{ $event->title }}" placeholder="Enter your event name">
    </div>
    <?php $category_array=explode(',', $event->category_id);?>
    <div class="form-group mt-3">
        <label for="#">{{ get_phrase('Parent Category') }}</label>
        <select name="parent" id="parent" class="selectpicker eForm-control select2 @error('parent') is-invalid @enderror"   required>
    ...
    <div class="form-group mt-3">
        ...
        <select name="category[]" id="category" class="selectpicker eForm-control select2 @error('category') is-invalid @enderror"  multiple required>
    ...
    <div class="row">
        <div class="form-group col-md-6 col-lg-6 col-sm-12">
            ...
            <input type="date" name="eventdate" class="form-control eForm-control" value="{{ $event->event_date }}" placeholder="Event Date">
        </div>
        <div class="form-group col-md-6 col-lg-6 col-sm-12">
            <label for="#">{{ get_phrase('Event Time') }}</label>
            <input type="time" name="eventtime" class="form-control eForm-control" value="{{ $event->event_time }}" placeholder="Event Time">
        </div>
    </div>
    <div class="row">
    <div class="form-group col-md-6 col-lg-6 col-sm-12">
        <label for="#">{{ get_phrase('State') }}</label>
        <select name="state" id="state" class="selectpicker eForm-control select2 @error('state') is-invalid @enderror" required>
    ...
    <div class="form-group col-md-6 col-lg-6 col-sm-12">
        ...
        <select name="city" id="city" class="selectpicker eForm-control select2 @error('city') is-invalid @enderror" required>
   ...
   <div class="row">
    <div class="form-group col-md-6 col-lg-6 col-sm-12">
        ...
        <select name="area" id="area" class="selectpicker eForm-control select2 @error('area') is-invalid @enderror"  required>
  ...
  <input type="text" name="eventlocation" class="form-control eForm-control" value="{{ $event->location }}" placeholder="Enter your location">
  </div>
</div>
          ...
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <div class="modal-body">
                        ...
                        <label class="text-black" for="category_parent_id">Parent</label>
                            ...
                            <select class="selectpicker eForm-control select2 @error('category_parent_id') is-invalid @enderror" name="category_parent_id" id="category_parent_id">
