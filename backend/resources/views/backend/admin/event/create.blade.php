...
<div class="event-tab bg-white border rounded p-3 pb-1">
    <form  action="{{ route('admin.event.store') }}" method="POST" enctype="multipart/form-data" >
        ...
        <div class="form-group mt-3">
            ...
            <input type="text" name="eventname" class="form-control eForm-control" placeholder="Enter your event name" value="{{ old('eventname') }}">
        </div>
        <div class="form-group mt-3">
    ...
    <div class="form-group mt-3">
        ...
        <select name="category[]" id="category" class="selectpicker eForm-control select2 @error('category') is-invalid @enderror"  multiple >
        ...
        <div class="row">
            <div class="form-group col-md-6 col-lg-6 col-sm-12">
                ...
                <input type="date" class="form-control eForm-control" name="eventdate" placeholder="Event Date" value="{{ old('eventdate') }}">
            </div>
            <div class="form-group col-md-6 col-lg-6 col-sm-12">
                <label for="#">{{ get_phrase('Event Time') }}</label>
                <input type="time" name="eventtime" class="form-control eForm-control" placeholder="Event Time" value="{{ old('eventtime') }}">
            </div>
        </div>
    <div class="row">
    <div class="form-group col-md-6 col-lg-6 col-sm-12">
        <label for="#">{{ get_phrase('State') }}</label>
        <select name="state" id="state" class="selectpicker eForm-control select2 @error('state') is-invalid @enderror" >
    ...
    <div class="form-group col-md-6 col-lg-6 col-sm-12">
        ...
        <select name="city" id="city" class="selectpicker eForm-control select2 @error('city') is-invalid @enderror" >
   ...
   <div class="row">
    <div class="form-group col-md-6 col-lg-6 col-sm-12">
        ...
        <select name="area" id="area" class="selectpicker eForm-control select2 @error('area') is-invalid @enderror"  >
    ...
    <input type="text" name="eventlocation" class="form-control eForm-control" placeholder="Enter your location" value="{{ old('eventlocation') }}">
    </div>
    </div>
