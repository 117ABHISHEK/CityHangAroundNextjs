<div class="sidebar">
      ...
      <ul class="nav-links">
        ...
        <!-- Developer Tools -->
        <li class="nav-links-li @if(Route::currentRouteName() == 'admin.dev-tools') showMenu @endif">
          <div class="iocn-link">
            <a href="{{ route('admin.dev-tools') }}">
              <div class="sidebar_icon">
                <i class="fa-solid fa-screwdriver-wrench"></i>
              </div>
              <span class="link_name">{{ get_phrase('Developer Tools') }} </span>
            </a>
          </div>
        </li>
        <!-- Sidebar menu -->

         <li class="nav-links-li @if(Route::currentRouteName() == 'admin.user.activity') showMenu @endif">
          <div class="iocn-link">
            <a class="w-100" href="{{ route('admin.user.activity') }}">
              <div class="sidebar_icon">
         ...
         <li class="nav-links-li @if(Route::currentRouteName() == 'admin.contact.queries') showMenu @endif">
            <div class="iocn-link">
              <a class="w-100" href="{{ route('admin.contact.queries') }}">
                <div class="sidebar_icon">
                  <i class="fa-solid fa-envelope"></i> {{-- You can change icon --}}
                </div>
                <span class="link_name">
                  {{ get_phrase('Contact Queries') }}
                </span>
              </a>
            </div>
          </li>
        ...
        <li class="nav-links-li @if(Route::currentRouteName()=='admin.view.category' || Route::currentRouteName()=='admin.users' || Route::currentRouteName()=='admin.user.add' || Route::currentRouteName()=='admin.user.edit')showMenu @endif">
          ...
          <ul class="sub-menu">
            <li><a  class="@if(Route::currentRouteName()=='admin.users')Active @endif" href="{{ route('admin.users') }}">{{ get_phrase('Users') }} ({{ \App\Models\User::where('user_role', '!=', 'admin')->count() }})</a></li>
...
<li class="nav-links-li">
  <div class="iocn-link">
    <a class="w-100" href="{{ route('manage.approval') }}">
      <div class="sidebar_icon">
        <i class="fas fa-check-circle"></i> <!-- Use any relevant icon -->
      </div>
      <span class="link_name">
        {{ get_phrase('Manage Approval') }}
      </span>
    </a>
  </div>
</li>
        ...
        <li class="nav-links-li @if(Route::currentRouteName()=='admin.user.page.category' || Route::currentRouteName()=='admin.user.product.category' || Route::currentRouteName()=='admin.user.event.category' || Route::currentRouteName()=='admin.user.city' || Route::currentRouteName()=='admin.user.area')showMenu @endif">
          ...
          <ul class="sub-menu">
          @php
            $categoryCount = DB::table('pagecategories')
                ->join('users', 'users.id', '=', 'pagecategories.category_createdby')
                ->whereNotNull('pagecategories.category_createdby')
                ->count();


        $productCategoryCount = DB::table('categories')
        ->join('users', 'users.id', '=', 'categories.product_category_createdby')
        ->whereNotNull('categories.product_category_createdby')
        ->count();


        $cityCount = DB::table('cities')
        ->join('users', 'users.id', '=', 'cities.createdby')
        ->whereNotNull('cities.createdby')
        ->count();


        $areaCount = DB::table('areas')
        ->join('users', 'users.id', '=', 'areas.createdby')
        ->whereNotNull('areas.createdby')
        ->count();


        $eventCategoryCount = DB::table('eventcategories')
        ->leftJoin('eventcategories as cat', 'cat.id', '=', 'eventcategories.category_parent_id')
        ->join('users', 'users.id', '=', 'eventcategories.category_createdby')
        ->count();
        @endphp
          <li><a  class="@if(Route::currentRouteName()=='admin.user.page.category' )Active @endif" href="{{ route('admin.user.page.category') }}">{{ get_phrase('Page Category') }}({{$categoryCount}}) </a></li>
            <li><a class="@if(Route::currentRouteName()=='admin.user.product.category')Active @endif" href="{{ route('admin.user.product.category') }}">{{ get_phrase('Product Category') }} ({{$productCategoryCount}})</a></li>
            <li><a class="@if(Route::currentRouteName()=='admin.user.event.category')Active @endif" href="{{ route('admin.user.event.category') }}">{{ get_phrase('Event Category') }} ({{$eventCategoryCount }})</a></li>
            <li><a class="@if(Route::currentRouteName()=='admin.user.city')Active @endif" href="{{ route('admin.user.city') }}">{{ get_phrase('City') }} ({{$cityCount}})</a></li>
            <li><a class="@if(Route::currentRouteName()=='admin.user.area')Active @endif" href="{{ route('admin.user.area') }}">{{ get_phrase('Area') }} ({{$areaCount}})</a></li>
            <li><a class="@if(Route::currentRouteName()=='spam.index')Active @endif" href="{{ route('spam.index') }}">{{ get_phrase('Spam Words') }}</a></li>
          </ul>
        </li>
        
        <li class="nav-links-li @if(Route::currentRouteName()=='admin.claim_listings'|| Route::currentRouteName()=='admin.page.pending' || Route::currentRouteName()=='admin.view.category' || Route::currentRouteName()=='admin.page' || Route::currentRouteName()=='admin.create.category' || Route::currentRouteName()=='admin.page.create' || Route::currentRouteName()=='admin.page.edit' ||  Route::currentRouteName() =='admin.listings.incomplete')showMenu @endif">
          <div class="iocn-link">
            <a href="#">
              <div class="sidebar_icon">
          ...
          <ul class="sub-menu">
            <li><a  class="@if(Route::currentRouteName()=='admin.page')Active @endif" href="{{ route('admin.page') }}">{{ get_phrase('Pages') }} ({{ \App\Models\Page::where('item_status',2)->count() }})</a></li>
            ...
            <li><a  class="@if(Route::currentRouteName()=='admin.page.pending')Active @endif" href="{{ route('admin.page.pending') }}">{{ get_phrase('Pending Pages') }} ({{ \App\Models\Page::where('item_status',1)->count() }})</a></li>
        ...
        <li class="nav-links-li  @if(Route::currentRouteName()=='admin.blog' || Route::currentRouteName()=='admin.view.blog.category' || Route::currentRouteName()=='admin.create.blog.category' || Route::currentRouteName()=='admin.blog.create' || Route::currentRouteName()=='admin.blog.edit')showMenu @endif">
          ...
          <ul class="sub-menu">
           ...
           <li class="nav-links-li @if(Route::currentRouteName() == 'admin.all.conversations.index') showMenu @endif">
  <div class="iocn-link">
    <a class="w-100" href="{{ route('admin.all.conversations.index') }}">
      <div class="sidebar_icon">
...
<li class="nav-links-li @if(Route::currentRouteName() == 'admin.all.market.conversations.index') showMenu @endif">
  <div class="iocn-link">
    <a class="w-100" href="{{ route('admin.all.market.conversations.index') }}">
      <div class="sidebar_icon">
        <i class="fa-solid fa-store"></i>
      </div>
      <span class="link_name">
