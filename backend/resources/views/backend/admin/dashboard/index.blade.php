...
<div class="main_content">
    ...
    <div class="row justify-content-evenly g-3">
      ...
      <div class="col-md-6 col-lg-6 col-xl-4">
        <div class="single-dash-box">
           <a href="{{route('admin.reported.post.view')}}" class="text-decoration-none">
      ...
      <div class="col-md-6 col-lg-6 col-xl-4">
        <div class="single-dash-box">
           <a href="{{route('admin.page')}}" class="text-decoration-none">
      ...
      <div class="col-md-6 col-lg-6 col-xl-4">
        <div class="single-dash-box">
           <a href="{{route('admin.blog')}}" class="text-decoration-none">
      ...
      <div class="col-md-6 col-lg-6 col-xl-4">
        <div class="single-dash-box">
           <a href="{{route('admin.view.event')}}" class="text-decoration-none">
           <div class="card colors-5">
              <div class="card-head d-flex justify-content-between align-items-center">
                  <p>{{get_phrase('Events')}}</p>
                  <span><i class="bi bi-arrow-right"></i></span>
              </div>
              <div class="card-body d-flex justify-content-between">
                  <div class="reader-book">
                  ...
                  <div class="reader-count">
                      <h4>{{DB::table('events')->get()->count()}}</h4>
                      <p>{{get_phrase('Total Events')}}</p>
                  </div>
              </div>
           </div>
           </a>
      ...
      <div class="col-md-6 col-lg-6 col-xl-4">
        <div class="single-dash-box">
           <a href="{{route('admin.group')}}" class="text-decoration-none">
           <div class="card colors-6">
              <div class="card-head d-flex justify-content-between align-items-center">
                  <p>{{get_phrase('Group')}}</p>
                  <span><i class="bi bi-arrow-right"></i></span>
              </div>
              <div class="card-body d-flex justify-content-between">
                  <div class="reader-book">
                  ...
                  <div class="reader-count">
                      <h4>{{DB::table('groups')->get()->count()}}</h4>
                      <p>{{get_phrase('Total Groups')}}</p>
                  </div>
              </div>
           </div>
           </a>
      ...
      <div class="col-md-12 col-lg-6 col-xl-4">
        <div class="single-dash-box">
           <a href="{{route('admin.view.sponsor')}}" class="text-decoration-none">
           <div class="card colors-1">
              <div class="card-head d-flex justify-content-between align-items-center">
                  <p>{{get_phrase('Ad')}}</p>
                  <span><i class="bi bi-arrow-right"></i></span>
