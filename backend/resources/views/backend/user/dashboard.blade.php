    ...
    <div class="row justify-content-evenly g-3">
      ...
      <div class="col-md-6 col-lg-6 col-xl-4">
        <div class="single-dash-box">
           <a href="{{ route('user.friends', auth()->id()) }}" class="text-decoration-none">
      ...
      <div class="col-md-6 col-lg-6 col-xl-4">
        <div class="single-dash-box">
           <a href="{{ route('user.pages') }}" class="text-decoration-none">
      ...
      <div class="col-md-6 col-lg-6 col-xl-4">
        <div class="single-dash-box">
           <a href="{{ route('myblog') }}" class="text-decoration-none">
      ...
      <div class="col-md-6 col-lg-6 col-xl-4">
        <div class="single-dash-box">
           <a href="{{ route('user.ads') }}" class="text-decoration-none">
