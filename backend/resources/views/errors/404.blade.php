    ...
    <main class="main my-4">
        <div class="container">
            <div class="row">
              ...
              <div class="col-lg-12 col-sm-12 order-3 order-lg-2 d-flex align-items-center justify-content-center">
    <div class="text-center">
        <img src="{{asset('storage/images/404-image.png')}}" alt="image" class="img-fluid mb-4" style="max-width: 300px;">
        <h1 class="mb-3">{{ get_phrase('404 page not found') }}</h1>
        <p class="mb-4">{{ get_phrase('This page is not available, please provide a valid URL') }}</p>
        <a class="btn btn-primary error-btn pe-4" href="{{url('/')}}"> 
            <i class="fas fa-arrow-left px-2"></i> {{ get_phrase('Back') }}
        </a>
    </div>
</div>
