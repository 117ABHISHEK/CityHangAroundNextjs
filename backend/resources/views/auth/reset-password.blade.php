@php 
    $auth_title = get_phrase('Reset Password');
    $meta_description = 'Enter your email address and select a secure new password to finalize your password recovery.';
@endphp
@include('auth.layout.header')

<style>
    /* Premium Reset Password Style Override */
    .auth-container {
        max-width: 1060px;
        width: 100%;
        margin: 40px auto;
    ...
    .custom-input-wrapper .form-control-password {
        ...
        <div class="row auth-card g-0">
            ...
            <div class="col-lg-6 auth-visual-panel">
                <div class="auth-visual-content">
                    <span class="auth-tagline">Security First</span>
                    <h2>Reset Your Account <span>Password</span></h2>
                    ...
                    <div class="auth-features">
                        <div class="feature-item">
                            ...
                            <div class="feature-text">
                                <h5>Strong Password Required</h5>
                                <p>Ensure your new password uses a secure mix of characters for ultimate safety.</p>
                            </div>
                        </div>
                        ...
                        <div class="feature-item">
                            ...
                            <div class="feature-text">
                                <h5>Account Encrypted</h5>
                                <p>All data and password revisions are hashed using high-level industry standards.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 auth-form-panel">
                <div class="auth-form-header">
                    <h3>{{ get_phrase('Reset Password') }}</h3>
                    <p>{{ get_phrase('Please enter your email and choose a secure new password to regain access.') }}</p>
                </div>
                ...
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-input-wrapper">
                            <input type="password" id="password" name="password" class="form-control form-control-password"
                                   placeholder="{{ get_phrase('Your new password') }}" required>
                    ...
                    <div class="form-group">
                        <label for="password_confirmation">{{ get_phrase('Confirm New Password') }}</label>
                        <div class="custom-input-wrapper">
                            <input type="password" id="password_confirmation" name="password_confirmation" class="form-control form-control-password"
                                   placeholder="{{ get_phrase('Confirm new password') }}" required>
                            <i class="fas fa-lock input-icon"></i>
