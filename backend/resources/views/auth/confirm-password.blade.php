@php 
    $auth_title = get_phrase('Confirm Password');
    $meta_description = 'This is a secure area of the application. Please confirm your password before continuing.';
@endphp
@include('auth.layout.header')

<style>
    /* Premium Confirm Password Style Override */
    .auth-container {
        max-width: 1060px;
        width: 100%;
        margin: 40px auto;
        ...
        <div class="row auth-card g-0">
            ...
            <div class="col-lg-6 auth-visual-panel">
                <div class="auth-visual-content">
                    <span class="auth-tagline">Security Verification</span>
                    <h2>Confirm Your <span>Password</span></h2>
                    ...
                    <div class="auth-features">
                        <div class="feature-item">
                            ...
                            <div class="feature-text">
                                <h5>Secure Area Access</h5>
                                <p>You're entering a sensitive part of the app. Please verify it's you to continue.</p>
                            </div>
                        </div>
                        ...
                        <div class="feature-item">
                            ...
                            <div class="feature-text">
                                <h5>Encrypted Verification</h5>
                                <p>Your session password check is validated securely using cryptographically safe mechanisms.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 auth-form-panel">
                <div class="auth-form-header">
                    <h3>{{ get_phrase('Confirm Password') }}</h3>
                    <p>{{ get_phrase('This is a secure area of the application. Please confirm your password before continuing.') }}</p>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-input-wrapper">
                            <input type="password" id="password" name="password" class="form-control form-control-password"
                                   placeholder="{{ get_phrase('Enter your password') }}" required autocomplete="current-password" autofocus>
