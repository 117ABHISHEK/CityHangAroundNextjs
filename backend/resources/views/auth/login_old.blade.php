            ...
            <div class="col-lg-6">
                <div class="login-txt ms-s ms-lg-5">
                    ...
                    <div class="social-login mt-4">
                        <h4 class="text-center">{{ get_phrase('Or login with') }}</h4>
                        <div class="d-flex justify-content-center mt-3">
                            <a href="{{ route('auth.google') }}" class="btn btn-danger me-3">
                                <i class="fab fa-google"></i> {{ get_phrase('Login with Google') }}
                            </a>
                            <a href="{{route('facebook.login')}}" class="btn btn-primary">
                                <i class="fab fa-facebook"></i> {{ get_phrase('Login with Facebook') }}
                            </a>
                        </div>
                    </div>
