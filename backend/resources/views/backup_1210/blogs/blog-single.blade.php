...
<?php
    ...
    {{ $created_at->setTimezone(optional(Auth::user())->timezone ?? 'Asia/Kolkata')->format('d-M-Y') }}
</span>
            ...
            <div class="entry-txt min-hight-125px">
                ...
                <div class="d-flex blog-ava">
                    ...
                    <div class="ava-info">
                        ...
                        <small>{{ $created_at->setTimezone(optional(Auth::user())->timezone ?? 'Asia/Kolkata')->format('d-M-Y') }} </small>
                    </div>
                </div>
            </div>
        </article>
