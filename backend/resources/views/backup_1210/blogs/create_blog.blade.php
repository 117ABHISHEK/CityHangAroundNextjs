...
<div class="page-wrap">
    ...
    <div class="card mt-3 px-3 py-4">
        <div class="create-article">
            ...
            <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <label for="author">
    {{ get_phrase('Author') }} <span class="text-danger">*</span>
</label>

                    <input type="text" name="author" placeholder="Enter Author Name" value="{{auth()->user()->name}}">
                </div>
                <div class="form-group">
    ...
    <div class="row">
            <div class="form-group col-md-6 col-lg-6 col-sm-12">
                ...
                <input type="date" name="publication_date" placeholder="Publication Date" value="{{ old('publication_date') }}">
            </div>
            <div class="form-group col-md-6 col-lg-6 col-sm-12">
