                ...
                @foreach ($pages as $key => $mypage )
                    <div class="col-lg-4 col-xl-3 col-md-4 col-6">
                        <div class="card sugg-card p-2 rounded">
                            <a href="{{ route('single.page',['city_slug'=>$mypage->city_slug,'area_slug'=>$mypage->area_slug,'category_slug'=>$mypage->category_slug,'item_slug'=>$mypage->item_slug]) }}" class="mb-2 thumbnail-110-auto" style="background-image: url('{{ get_page_logo($mypage->logo, 'logo') }}')"></a>
