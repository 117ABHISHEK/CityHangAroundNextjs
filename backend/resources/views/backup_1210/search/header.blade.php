<div class="tags">
    ...
    <a class="@if(Route::currentRouteName() == 'search.product') active @endif" href="{{ url('search/product?search='.$_GET['search']) }}"><i class="fa fa-store me-2"></i>{{ get_phrase('Deals') }}</a>
    <a class="@if(Route::currentRouteName() == 'search.page') active @endif" href="{{ url('search/page?search='.$_GET['search']) }}"><i class="fa fa-flag me-2"></i>{{ get_phrase('Merchants') }}</a>
    <a class="@if(Route::currentRouteName() == 'search.group.specific') active @endif" href="{{ url('search/group?search='.$_GET['search']) }}"><i class="fa fa-address-card me-2"></i>{{ get_phrase('Community') }}</a>
</div>