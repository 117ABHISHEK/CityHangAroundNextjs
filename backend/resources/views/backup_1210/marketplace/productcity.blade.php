...
<script type="application/ld+json">
            {
                 ...
                 "@type":"LocalBusiness",
                 "name":"Top 5 Deals in {{$city->city_name}}",
...
<div class="row mb-4">
    ...
    <h1 class="font-weight-light text-primary">Best Deals & Discounts in {{ $city->city_name}} – Save More with Limited-Time Offers</h1>
...
<script>
     ...
     $(document).ready(function() {
        ...
        $('#area_filter, #category_filter, #subcategory_filter').on('change', function() {
            $('#filterForm').submit();
        });
