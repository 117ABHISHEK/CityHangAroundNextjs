    ...
    <div class="single-item-countable d-flex friend-item align-items-center justify-content-between mb-3">
        <div class="d-flex align-items-center w-100">
            ...
            <div class="avatar-info ms-2">
                ...
                <div class="activity-time small-text text-muted"> {{$number_of_mutual_friends}} {{get_phrase('Mutual Following')}}</div>
            </div>
        </div>
        <div class="post-controls dropdown dotted">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                @endif
                <li> <a class="dropdown-item" href="javascript:void(0)" onclick="confirmAction('<?php echo route('user.unfriend', $friend_id); ?>', true)">{{get_phrase('Unfollow')}}</a> </li>
            </ul>
        </div>
    </div>
@endforeach
