@foreach($all_videos as $video)
    <div class="single-item-countable single-photo">
            <video onclick="$(location).prop('href', '{{route('single.post', $video->post_id)}}')" class="w-100 video_details_height2 cursor-pointer" muted src="{{get_video_url($video->file_name)}}">
