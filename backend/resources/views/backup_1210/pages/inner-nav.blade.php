 <nav class="profile-nav border bg-white mb-3"> 
    ...
    @endphp
    <li class="nav-item @if(Route::currentRouteName() == 'single.page') active @endif"><a href="{{ route('single.page',['city_slug'=>$page->city->city_slug,'area_slug'=>$page->area->area_slug,'category_slug'=>$catslug,'item_slug'=>$page->item_slug]) }}" class="nav-link">{{ get_phrase('Buzz') }}</a></li>
        ...
        <li class="nav-item @if(Route::currentRouteName() == 'page.videos') active @endif"><a href="{{ route('page.videos',['city_slug'=>$page->city->city_slug,'area_slug'=>$page->area->area_slug,'category_slug'=>$catslug,'item_slug'=>$page->item_slug]) }}" class="nav-link">{{ get_phrase('Video') }}</a></li>
                        ...
                        <li class="nav-item @if(Route::currentRouteName() == 'pages.products') active @endif"><a href="{{route('pages.products',['city_slug'=>$page->city->city_slug,'area_slug'=>$page->area->area_slug,'category_slug'=>$catslug,'item_slug'=>$page->item_slug])}}" class="nav-link">{{get_phrase('Deals')}}</a></li>
