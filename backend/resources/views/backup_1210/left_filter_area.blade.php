...
<div class="widget_top_filter">
    ...
    <div class="filter-section">
        <form method="GET" action="{{ route('page.city.area',['city_slug'=>$city->city_slug,'area_slug'=>$area->area_slug]) }}" id="filterForm">
            ...
            <div class="reset-section">
                <a class="reset-btn" href="{{ route('page.city.area',['city_slug'=>$city->city_slug,'area_slug'=>$area->area_slug]) }}">
    ...
    <div class="tags_Outer">
        <div class="owl-carousel tag-carousel owl-theme">
            @foreach ($all_categories as $cat)
            <div class="item">
                <a href="{{ route('page.category.city',['category_slug'=>$cat->category_slug,'city_slug'=>$city->city_slug]) }}">
                    {{ $cat->category_name }}
                </a>
            </div>
            @endforeach
...
$(document).ready(function() {
    ...
    $('#filter_category, #filter_sort_by').on('change', function() {
