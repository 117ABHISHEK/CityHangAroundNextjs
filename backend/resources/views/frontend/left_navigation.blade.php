<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header d-lg-none py-4">
        <div class="logo">
            <img class="max-width-200" width="80%" src="{{ get_system_logo_favicon(get_settings('system_dark_logo'), 'dark') }}" alt="">
        </div>
            ...
            <nav class="menu-wrap">
                <ul>
                    <li class="@if(Route::currentRouteName()=='timeline' || Route::currentRouteName()=='single.post') active @endif"><a href="{{ route('timeline') }}"><img src="{{asset('storage/images/timeline-2.svg')}}"
                                alt="Timeline">{{ get_phrase('Buzz') }}</a></li>
                    ...
                    <li class="@if(Route::currentRouteName()=='groups' || Route::currentRouteName()=='single.group'|| Route::currentRouteName()=='group.people.info'|| Route::currentRouteName()=='group.event.view'|| Route::currentRouteName()=='single.group.photos') active @endif"><a href="{{ route('groups') }}"><img src="{{asset('storage/images/group-2.svg')}}" alt="Group">{{ get_phrase('Community') }}</a></li>
                    <li class="@if(Route::currentRouteName()=='pages' || Route::currentRouteName()=='single.page'|| Route::currentRouteName()=='single.page.photos'|| Route::currentRouteName()=='page.videos') active @endif"><a href="{{ route('pages') }}"><img src="{{asset('storage/images/page-2.svg')}}" alt="Page">{{ get_phrase('Merchants') }}</a></li>
                    <li class="@if(Route::currentRouteName()=='allproducts' || Route::currentRouteName()=='userproduct'|| Route::currentRouteName()=='single.product'|| Route::currentRouteName()=='filter.product'|| Route::currentRouteName()=='product.saved') active @endif"><a href="{{ route('allproducts') }}"><img src="{{asset('storage/images/marketplace-2.svg')}}" alt="Marketplace">{{ get_phrase('Deals') }}</a>
                    </li>
