...
<div class="widget_top_filter d-none d-lg-block">
    ...
    <form method="GET" action="{{ route('category.blog', ['category_slug' => $category->category_slug]) }}" id="filterFormDesktop">
        <div class="left_size_custom_section">
            ...
            <div class="form-group">
                ...
                <select id="category_filter" name="category" class="custom-select-premium">
                    ...
                    @foreach ($categories as $cat)
                        <option value="{{ route('category.blog',['category_slug'=>$cat->category_slug]) }}" {{ $category->id == $cat->id ? 'selected' : '' }}>
                            {{ $cat->category_name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="action-row">
                <a class="btn-reset" href="{{ route('category.blog', ['category_slug' => $category->category_slug]) }}">
                    Reset
                </a>
...
<div id="mobileSidebar" class="d-lg-none">
    ...
    <div class="p-4">
        ...
        <form method="GET" action="{{ route('category.blog', ['category_slug' => $category->category_slug]) }}" id="filterForm">
            <div class="left_size_custom_section">
                <!-- Mobile City Search -->
                <div class="form-group">
