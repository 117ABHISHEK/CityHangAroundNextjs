...
<label for="#">{{ get_phrase('Latitude') }}</label>
        <input id="item_lat" name="item_lat" type="text" class="border-0 bg-secondary mb-1"  value="{{ $page->item_lat }}" >
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="file" name="featured_thumbnail" class="border-0 bg-secondary" id="featured_thumbnail" class="form-control">
    </div>
