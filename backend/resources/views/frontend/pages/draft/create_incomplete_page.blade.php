...
<form id="listing-form"  action="{{ route('page.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <!-- Modern Bootstrap Tabs Header -->
    <ul class="nav nav-tabs nav-tabs-custom mb-4" id="resumeFormTabs" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="location-tab" data-bs-toggle="tab" data-bs-target="#location-info" type="button" role="tab" aria-controls="location-info" aria-selected="false">
                <i class="fas fa-map-marked-alt me-1"></i> Location & Contact
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="social-tab" data-bs-toggle="tab" data-bs-target="#social-info" type="button" role="tab" aria-controls="social-info" aria-selected="false">
                <i class="fas fa-share-alt me-1"></i> Social Links
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="business-tab" data-bs-toggle="tab" data-bs-target="#business-info" type="button" role="tab" aria-controls="business-info" aria-selected="false">
                <i class="fas fa-briefcase me-1"></i> Business Details
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="policy-tab" data-bs-toggle="tab" data-bs-target="#policy-info" type="button" role="tab" aria-controls="policy-info" aria-selected="false">
                <i class="fas fa-file-contract me-1"></i> Policy & FAQ
            </button>
        </li>
    </ul>

    <div class="tab-content p-2" id="resumeFormTabsContent">
        <!-- Tab 1: Basic Info -->
        <div class="tab-pane fade show active" id="basic-info" role="tabpanel" aria-labelledby="basic-tab">
            ...
            <div class="form-group">
                ...
                <a class="text-info pl-2 float-left" onclick="showparentcategorymodel();" style="cursor:pointer;">
            ...
            <div class="form-group">
                ...
                <a class="text-info pl-2 float-left" onclick="showcategorymodel();" style="cursor:pointer;">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="border-0 bg-secondary" name="yrofest"  placeholder="Year of Establishment" value="{{ old('yrofest', $listing->data->yrofest ?? '') }}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="#">{{ get_phrase('Profile Photo') }}</label>
                        <input type="file" name="image" class="border-0 bg-secondary form-control" id="image">
                    </div>
                </div>
            </div>
            ...
            <div class="tab-navigation-buttons">
                <div></div>
                <button type="button" class="btn btn-primary next-tab-btn" data-next-tab="location-tab">Next: Location & Contact <i class="fas fa-arrow-right ms-1"></i></button>
            </div>
        </div>
        ...
        <div class="tab-pane fade" id="location-info" role="tabpanel" aria-labelledby="location-tab">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <a class="text-info pl-2 float-left" onclick="showcitymodel();" style="cursor:pointer;">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <a class="text-info pl-2 float-left" onclick="showareamodel();" style="cursor:pointer;">
            ...
            <div class="row mb-3">
                <div class="col-lg-6">
                    ...
                    <a class="lat_lng_select_button btn btn-sm btn-primary text-white mt-1">Select on map</a>
                </div>
                <div class="col-lg-6">
            ...
            <div class="tab-navigation-buttons">
                <button type="button" class="btn btn-secondary prev-tab-btn" data-prev-tab="basic-tab"><i class="fas fa-arrow-left me-1"></i> Previous: Basic Info</button>
                <button type="button" class="btn btn-primary next-tab-btn" data-next-tab="social-tab">Next: Social Links <i class="fas fa-arrow-right ms-1"></i></button>
            </div>
        </div>

        <!-- Tab 3: Social Links -->
        <div class="tab-pane fade" id="social-info" role="tabpanel" aria-labelledby="social-tab">
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="border-0 bg-secondary" name="youtube_video_id" placeholder="Enter Youtube video id" value="{{ old('youtube_video_id', $listing->data->youtube_video_id ?? '') }}">
                    </div>
                </div>
            </div>

            <div class="tab-navigation-buttons">
                <button type="button" class="btn btn-secondary prev-tab-btn" data-prev-tab="location-tab"><i class="fas fa-arrow-left me-1"></i> Previous: Location</button>
                <button type="button" class="btn btn-primary next-tab-btn" data-next-tab="business-tab">Next: Business Details <i class="fas fa-arrow-right ms-1"></i></button>
            </div>
        </div>
        ...
        <div class="tab-pane fade" id="business-info" role="tabpanel" aria-labelledby="business-tab">
            ...
            <div class="form-group">
                ...
                <textarea name="visitus" class="border-0 bg-secondary content" id="visitus" rows="5" placeholder="Why Visit Us">{{ old('visitus', $listing->data->visitus ?? '') }}</textarea>
            </div>

            <div class="form-group">
                <label for="#">{{ get_phrase('Our Story') }}</label>
                <textarea name="our_story" class="border-0 bg-secondary content" id="our_story" rows="5" placeholder="Our Story">{{ old('our_story', $listing->data->our_story ?? '') }}</textarea>
            </div>
            ...
            <div class="tab-navigation-buttons">
                <button type="button" class="btn btn-secondary prev-tab-btn" data-prev-tab="social-tab"><i class="fas fa-arrow-left me-1"></i> Previous: Social Links</button>
                <button type="button" class="btn btn-primary next-tab-btn" data-next-tab="policy-tab">Next: Policy & FAQ <i class="fas fa-arrow-right ms-1"></i></button>
            </div>
        </div>

        <!-- Tab 5: Policy & FAQ -->
        <div class="tab-pane fade" id="policy-info" role="tabpanel" aria-labelledby="policy-tab">
            <div class="form-group">
                <label for="#">{{ get_phrase('Return/Refund Policy') }}</label>
                <textarea name="policy" class="border-0 bg-secondary content" id="policy" rows="5" placeholder="Return/Refund Policy">{{ old('policy', $listing->data->policy ?? '') }}</textarea>
            </div>
            ...
            <button type="button" id="add-faq" class="btn btn-success py-2 px-4 text-white mb-4">Add Another FAQ</button>
            ...
            <div class="form-group">
                ...
                <input type="file" name="Proof_of_Ownership" class="border-0 bg-secondary form-control" id="Proof_of_Ownership">
            </div>

            <div class="form-group style-checkbox" style="display: flex; gap: 8px; font-size: 16px; align-items: baseline; margin-top: 20px;">
                ...
                <label for="terms" class="mb-0" style="cursor: pointer;">
                    I agree to the <a onclick="showtermsymodel()" style="color: #007bff; text-decoration: none; font-weight: 500; cursor: pointer;">Terms and Conditions</a>
                </label>
            </div>

            <button type="submit" class="w-100 btn btn-primary mt-3">{{ get_phrase('Create Page') }}</button>
            <input type="hidden" name="listing_id" value="{{ $listing->id }}">

            <div class="tab-navigation-buttons">
                <button type="button" class="btn btn-secondary prev-tab-btn" data-prev-tab="business-tab"><i class="fas fa-arrow-left me-1"></i> Previous: Business Details</button>
                <div></div>
            </div>
        </div>
    </div>
...
<script>
 ...
 $(document).ready(function() {
    ...
    // Tab Next/Previous button triggers
    $('.next-tab-btn').on('click', function() {
        let nextTabId = $(this).data('next-tab');
        let nextTabTrigger = document.querySelector('#' + nextTabId);
        if (nextTabTrigger) {
            new bootstrap.Tab(nextTabTrigger).show();
            // Scroll to the top of the form tabs smoothly
            $('html, body').animate({
                scrollTop: $("#resumeFormTabs").offset().top - 100
            }, 200);
        }
    });

    $('.prev-tab-btn').on('click', function() {
        let prevTabId = $(this).data('prev-tab');
        let prevTabTrigger = document.querySelector('#' + prevTabId);
        if (prevTabTrigger) {
            new bootstrap.Tab(prevTabTrigger).show();
            $('html, body').animate({
                scrollTop: $("#resumeFormTabs").offset().top - 100
            }, 200);
        }
