                ...
                <div class="col-6 col-md-4 col-lg-6 col-xl-4" id="product-{{ $product->id }}">
                    <div class="card product p-3">
                        <div class="product-figure position-relative">
                            <a href="{{ route('single.product',['city_slug'=>$pages[0]->city_slug,'area_slug'=>$pages[0]->area_slug,'category_slug'=>$catslug,'item_slug'=>$pages[0]->item_slug,'product_category_slug'=>$productcatslug,'product_slug'=>$product->product_slug]) }}"><img src="{{ get_marketplace_banner_image($product, 'thumbnail') }}" alt="" class="img-fluid"></a>
