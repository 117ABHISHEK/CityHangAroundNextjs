...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/frontend/css/own.css') }}?v=1.6">
    <noscript>
        <link rel="stylesheet" href="{{ asset('assets/frontend/css/fontawesome/all.min.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/frontend/css/owl.carousel.min.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/frontend/css/nice-select.css') }}">
...
<body>
    ...
    <main class="main my-4">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2">
                    @include('frontend.left_product_category_filter')
                </div>
                ...
                <div class="col-lg-3 order-2 order-lg-3">
                    @include('frontend.right_sidebar_deals')
                </div>
            </div> 
        </div> 
    </main>
    ...
    <!-- Javascript: Bootstrap bundle MUST load before bootstrap-select (selectpicker dropdowns). -->
    ...
    @stack('product_category_filter_scripts')
