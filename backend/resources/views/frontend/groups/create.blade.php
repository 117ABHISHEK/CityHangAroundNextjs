...
<form action="{{ route('group.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group pt-2">
        ...
        <input type="text" class="border-0 bg-secondary"  name="name" value="{{ old('name') }}"  placeholder="Enter your page Name">
    </div>
    <div class="form-group" hidden> 
        <label for="#">{{ get_phrase('Group Sub Title') }}</label>
        <input type="text" class="border-0 bg-secondary" name="subtitle" value="{{ old('subtitle') }}" placeholder="Enter your page Name">
    </div>
    ...
    <div class="form-group">
        ...
        <textarea name="about" class="border-0 bg-secondary content" id="about" cols="30" rows="10" placeholder="About Group">{{ old('about') }}</textarea>
    </div>
    <div class="row">
    <div class="col-lg-6">
        <div class="form-group">
   ...
   <div class="col-lg-6">
    <div class="form-group">
        ...
        <a  class="text-info pl-2 float-left" onclick="showcitymodel();" ><i class="far fa-add"></i> Suggest City</a>
    </div>
    </div>
   <div class="col-lg-6">
    <div class="form-group">
  ...
  <div class="col-lg-6">
    ...
    <div class="form-group" hidden>
        ...
        <select name="status" id="status" class="form-control border-0 bg-secondary">
            <option value="1" selected>{{ get_phrase('Active') }}</option>
    ...
    <label for="terms" class="mb-0" style="cursor: pointer;">
        I agree to the <a href="#" data-toggle="modal" data-target="#termsModal" style="color: #007bff; text-decoration: none; font-weight: 500;">Terms and Conditions</a>
    </label>
</div>
            ...
            <div class="modal-body">
                <form id="categoryForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <select class="selectpicker form-control @error('category_parent_id') is-invalid @enderror" name="category_parent_id" id="category_parent_id" data-container="body">
