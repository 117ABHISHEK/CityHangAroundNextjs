                        ...
                        <div class="card mt-3">
                            ...
                            @foreach ($group_events as $event )
                                <div class="single-event card my-2 border-0 px-3" id="event-{{ $event->id }}">
                                    <div class="row g-0">
                                        <div class="col-md-5 col-lg-12 col-xl-5" style="background-image: url('{{ get_event_banner_image($event, 'thumbnail') }}'); background-size: 100%; background-position: center; background-repeat: no-repeat; background-color: #f3f3f3;">
                                        </div>
