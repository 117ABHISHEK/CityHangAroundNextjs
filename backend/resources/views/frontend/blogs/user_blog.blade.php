    ...
    ?>
            <div class="col-12 col-sm-6 col-md-4 col-lg-6 col-xl-4" id="blog-{{ $blog->id }}">
                <article class="single-entry">
                    <div class="entry-img">
                        <a href="{{ route('single.blog',['city_slug'=>$blog->city_slug,'area_slug'=>$blog->area_slug,'category_slug'=>$catslug,'blog_slug'=>$blog->blog_slug]) }}"><img src="{{ get_blog_banner_image($blog, 'thumbnail') }}" alt="" class="img-fluid w-100"></a>
