...
$schema = [
    ...
    "@type" => "ItemList",
    "name" => "Top Local Businesses in {$city->city_name}",
    "url" => request()->fullUrl(),
];
@endphp
                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-white pl-0 pr-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('blog.city',['city_slug'=>$city->city_slug])}}">{{ $city->city_name }}</a></li>
...
<div class="page-wrap">
    ...
    <div class="row g-3 blog-cards mt-1">
       ...
       $catslug = $categoriesss->category_slug ?? '';
$cat_name = $categoriesss->category_name ?? '';
