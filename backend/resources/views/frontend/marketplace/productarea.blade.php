...
$schema = [
    ...
    "@type" => "ItemList",
    "name" => "Top Deals in {$area->area_name}, {$city->city_name}",
    "url" => request()->fullUrl(),
];
@endphp
...
<!-- </div> -->
    ...
    <div class="deals-page-header">
        <span class="deals-subtitle">Neighborhood Savings</span>
        <h1 class="deals-title">Best Deals & Discounts in {{ $area->area_name}}, {{ $city->city_name}}</h1>
        <p class="deals-desc">Discover outstanding local savings, dining discounts, and regional offers right here in {{ $area->area_name }}, {{ $city->city_name }}.</p>
    </div>
