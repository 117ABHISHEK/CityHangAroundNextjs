                                        ...
                                        @else
                                            <div class="picture text-center"> 
                                                <a onclick="showCustomModal('{{route('preview_post', ['post_id' => $post->post_id, 'file_name' => $media_file->file_name])}}', '{{get_phrase('Preview')}}', 'xxl')" href="javascript:void(0)">
                                                    ...
                                                    <img src="{{get_post_image($media_file->file_name, 'optimized')}}" class="w-100 h-100 @if($media_files_count == 1) single-image-ration @endif {{ $opacity }}" alt="">
                                                </a>
                                            </div>
                                        @endif
...
<ul class="react-list">
<li>
<a href="javascript:void(0)" onclick="myReact('post','like','update',{{$post->post_id}})">
<img src="https://cdn-icons-png.flaticon.com/128/742/742751.png">
</a>
</li>

<li>
<a href="javascript:void(0)" onclick="myReact('post','love','update',{{$post->post_id}})">
<img src="https://cdn-icons-png.flaticon.com/128/833/833472.png">
</a>
</li>

<li>
<a href="javascript:void(0)" onclick="myReact('post','sad','update',{{$post->post_id}})">
<img src="https://cdn-icons-png.flaticon.com/128/742/742774.png">
</a>
</li>

<li>
<a href="javascript:void(0)" onclick="myReact('post','angry','update',{{$post->post_id}})">
<img src="https://cdn-icons-png.flaticon.com/128/742/742767.png">
</a>
</li>
</ul>
                    </span>
...
<style>/* reaction button container */
