    ...
    <div class="form-group col-md-6 col-lg-6 col-sm-12">
        ...
        <select name="country_id" id="country_id" class="selectpicker form-control @error('country_id') is-invalid @enderror">
            ...
            @foreach ($all_countries ?? [] as $cnt)
                <option value="{{ $cnt->id }}" {{ ($event->country_id ?? 101) == $cnt->id ? 'selected' : '' }}>{{ $cnt->country_name }}</option>
            @endforeach
        </select>
    </div>
    {{-- State --}}
...
<div class="form-group mt-3">
    ...
    <select name="event_type" id="event_type" class="form-control selectpicker-select2">
        <option value="offline" {{ ($event->event_type ?? 'offline') == 'offline' ? 'selected' : '' }}>Offline</option>
...
<div class="row">
    <div class="form-group col-md-6 col-lg-6 col-sm-12">
        ...
        <input type="datetime-local" name="start_datetime" id="start_datetime" class="form-control"
               value="{{ $event->start_datetime ? \Carbon\Carbon::parse($event->start_datetime)->format('Y-m-d\TH:i') : '' }}">
    </div>
    <div class="form-group col-md-6 col-lg-6 col-sm-12">
        ...
        <input type="datetime-local" name="end_datetime" id="end_datetime" class="form-control"
               value="{{ $event->end_datetime ? \Carbon\Carbon::parse($event->end_datetime)->format('Y-m-d\TH:i') : '' }}">
    </div>
</div>
...
<div class="form-group mt-3">
    ...
    <input type="text" name="venue_name" id="venue_name" class="form-control"
           placeholder="e.g. City Convention Hall" value="{{ $event->venue_name ?? '' }}">
</div>
<div class="form-group mt-3">
    <label for="address">{{ get_phrase('Full Address') }}</label>
    <textarea name="address" id="address" class="form-control" rows="2"
              placeholder="Street, City, PIN">{{ $event->address ?? '' }}</textarea>
</div>
...
<div class="row">
    <div class="form-group col-md-12 col-lg-12 col-sm-12">
        ...
        <input type="url" name="map_url" id="map_url" class="form-control"
               placeholder="https://maps.google.com/..." value="{{ $event->map_url ?? '' }}">
    </div>
</div>
...
@if(!empty($event->logo))
<div class="form-group mt-3">
    <label>{{ get_phrase('Current Logo') }}</label><br>
    <img src="{{ viewImage('event', $event->logo, 'logo') }}" class="rounded" style="max-height:80px;" alt="Logo">
</div>
@endif
<div class="form-group mt-3">
...
<div class="form-group mt-3">
    ...
    <input type="url" name="website" id="website" class="form-control"
           placeholder="https://youreventsite.com" value="{{ $event->website ?? '' }}">
</div>
...
<div class="row mt-3">
    <div class="form-group col-md-6 col-lg-6 col-sm-12">
        <div class="form-check mt-4">
            <input class="form-check-input" type="checkbox" name="registration_required" id="registration_required"
                   value="1" {{ ($event->registration_required ?? false) ? 'checked' : '' }}>
    ...
    <div class="form-group col-md-6 col-lg-6 col-sm-12">
        ...
        <input type="datetime-local" name="registration_deadline" id="registration_deadline" class="form-control"
               value="{{ $event->registration_deadline ? \Carbon\Carbon::parse($event->registration_deadline)->format('Y-m-d\TH:i') : '' }}">
    </div>
</div>
...
<div class="row">
    <div class="form-group col-md-6 col-lg-6 col-sm-12">
        ...
        <input type="url" name="booking_url" id="booking_url" class="form-control"
               placeholder="https://bookmyshow.com/..." value="{{ $event->booking_url ?? '' }}">
    </div>
    <div class="form-group col-md-6 col-lg-6 col-sm-12">
        ...
        <input type="number" min="1" name="max_capacity" id="max_capacity" class="form-control"
               placeholder="e.g. 500" value="{{ $event->max_capacity ?? '' }}">
    </div>
</div>
...
<div class="form-check mt-3">
    <input class="form-check-input" type="checkbox" name="featured" id="featured"
           value="1" {{ ($event->featured ?? false) ? 'checked' : '' }}>
