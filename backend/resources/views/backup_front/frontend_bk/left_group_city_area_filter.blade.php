...
<div class="widget_top_filter">
    ...
    <div class="row">
        <form method="GET" action="{{ route('group.city.area', ['city_slug'=>$city->city_slug,'area_slug' => $area->area_slug]) }}">
            <div class="form-group">
                ...
                <div class="form-group-col">
                    <a class="reset-btn btn btn-outline-primary rounded" href="{{ route('group.city.area', ['city_slug'=>$city->city_slug,'area_slug' => $area->area_slug]) }}">
                        Reset
                    </a>
                </div>
                <div class="form-group-col">
