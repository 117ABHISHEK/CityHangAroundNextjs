        ...
        <div class="card people-card p-4 mt-4 mb-3">
            ...
            <div class="people-wrap mt-2">
                <div class="people-item d-flex mb-3 justify-content-between w-100">
                    ...
                    @if ($friend>0)
                        @if ($friendAccepted>0)
                            <a href="#" class="btn btn-secondary align-self-start"><i class="fa-solid fa-user-group"></i> {{ get_phrase('Following') }} </a>
                        @else
                        ...
                        @endif
                    @else   
                        <a href="javascript:void(0)" onclick="ajaxAction('<?php echo route('user.friend',$people->id); ?>')" class="btn btn-primary align-self-start"><i class="fa-solid fa-plus"></i> {{ get_phrase('Follow') }} </a>
                    @endif
                </div>
            </div>
            @endforeach
