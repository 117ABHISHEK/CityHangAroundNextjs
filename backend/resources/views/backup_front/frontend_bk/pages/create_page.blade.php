...
<form id="listing-form"  action="{{ route('page.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="#">{{ get_phrase('Type Category name here') }} <span class="text-danger">*</span></label>
    ...
    <div class="form-group">
        <label for="#">{{ get_phrase('Type Sub Category here') }} <span class="text-danger">*</span></label>
        ...
        <a  class="text-info pl-2 float-left" style="color: #ff4437 !important;" onclick="showcategorymodel();" >
                                                <i class="far fa-add"></i>
...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="form-group">
            ...
            <a class="text-info pl-2 float-left" style="color: #ff4437 !important;" onclick="showcitymodel();">
    ...
    <div class="col-lg-6">
        <div class="form-group">
            ...
            <a class="text-info pl-2 float-left" style="color: #ff4437 !important;" onclick="showareamodel();" data-bs-toggle="modal">
...
<div class="modal fade" id="claimModal" tabindex="-1" role="dialog" aria-labelledby="claimModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a id="viewListingBtn" href="https://example.com" target="_blank" class="btn btn-primary">View Listing</a>
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
      </div>
...
<!-- ✅ Bootstrap JS (after jQuery and Popper) -->
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.exists && !response.hasPhone) {
                       // let claimUrl = `/${response.city_slug}/${response.area_slug}/${response.category_slug}/${response.item_slug}`;
...
//showModal('vadodara/karelibaug/quick-bites-restaurants/raju-omlet');
...
function showModal(url) {
    console.log('URL to set:', url);  // for debugging
    $('#viewListingBtn').attr('href', url);  // Add leading slash
