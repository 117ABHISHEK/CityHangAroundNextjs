...
<div class="page-wrap">
    ...
    <div class="row">
       ...
       value="{{ $blog->publication_date ? \Carbon\Carbon::parse($blog->publication_date)->format('Y-m-d') : '' }}"
       >
  ...
  <div class="col-lg-6">
                ...
                <option value="">{{ get_phrase('Select') }}</option>
                <option value="publish" {{ ("publish"==$blog->publication_status) ? 'selected' : '' }}>Publish</option>
                <option value="scheduled" {{ ("scheduled"==$blog->publication_status) ? 'selected' : '' }}>Scheduled</option>
                <option value="draft" {{ ("draft"==$blog->publication_status) ? 'selected' : '' }}>Draft</option>
                </select>
                </div>
                <div class="form-group">
