...
<div class="widget_top_filter">
    ...
    <div class="filter-section">
        <form method="GET" action="{{ route('page.category.city', ['category_slug' => $category->category_slug, 'city_slug' => $city->city_slug]) }}" id="filterForm">
            ...
            <div class="reset-section">
                <a class="reset-btn" href="{{ route('page.category.city', ['category_slug' => $category->category_slug, 'city_slug' => $city->city_slug]) }}">
