...
export default function TrendingCities() {
  return (
    <section className={`${styles.trendingCities} py-20 bg-white`}>
      <div className="container mx-auto px-6">
        ...
        <div className="relative">
          <div className="flex items-center justify-between gap-3 overflow-hidden">
            <button className="rounded-2xl border border-slate-200 bg-white px-4 py-3 text-slate-700 shadow-sm hover:bg-slate-50">
              ←
            </button>
