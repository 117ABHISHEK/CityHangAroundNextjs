...
export default function SecondarySection() {
  return (
    <section className={`${styles.secondarySection} py-20 bg-white`}>
      <div className="container mx-auto px-6">
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div className="rounded-[32px] bg-slate-950 p-8 text-white shadow-2xl">
            <div className="inline-flex rounded-3xl bg-red-600/15 px-4 py-2 text-sm font-semibold text-red-200">
              Get Found
            </div>
