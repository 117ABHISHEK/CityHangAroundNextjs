...
export default function HeroSection() {
  return (
    <section className={`${styles.heroSection} relative overflow-hidden bg-white`}>
        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="max-w-2xl">
            ...
            <div className="mt-10 flex flex-col gap-3 sm:flex-row">
              <button className="rounded-3xl bg-red-600 px-6 py-3 text-sm font-semibold text-white hover:bg-red-700">
                Start Exploring Free
              </button>
              <button className="rounded-3xl border border-slate-200 bg-white px-6 py-3 text-sm font-semibold text-slate-700 hover:border-red-600 hover:text-red-600">
